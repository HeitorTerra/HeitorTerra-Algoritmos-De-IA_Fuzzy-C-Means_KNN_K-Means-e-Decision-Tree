...
from sklearn.tree import DecisionTreeClassifier # Algoritmo Decision Tree
...
model = DecisionTreeClassifier() # Atribuindo a classe DecisionTreeClassifier() ao objeto "model"
...
plt.title('Resultados Obtidos vs Resultados Reais (Decision Tree)') # Título do gráfico
