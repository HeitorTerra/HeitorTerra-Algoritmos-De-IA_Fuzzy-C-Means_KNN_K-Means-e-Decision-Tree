...
# Treinando o KNN
model = KNeighborsClassifier(n_neighbors = 3) # Atribuindo a classe KNeighborsClassifier() ao objeto "model"
...
plt.title('Resultados Obtidos vs Resultados Reais (KNN)') # Título do gráfico
